...
export function CourseFlashcardCatalog({
  ...
  if (chapters.length === 0) {
    return (
      <div className="flex min-h-72 w-full flex-col items-center justify-center rounded-2xl border border-outline-variant/35 bg-gradient-to-br from-landing-white via-landing-cream to-secondary-container/25 p-md text-center shadow-lg shadow-landing-text/5">
        ...
        <p className="mt-2 w-full max-w-[28rem] text-body-md text-landing-text-soft">
