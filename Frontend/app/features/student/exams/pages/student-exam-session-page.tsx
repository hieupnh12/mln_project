...
import {
  ...
  isQuestionAnswered,
  toggleExamAnswerSelection,
} from "../utils/exam-answer.helpers";
import {
  getExamDraftKey,
  loadExamDraft,
  saveExamDraft,
...
export function StudentExamSessionPage() {
  ...
  const isAnswered = useCallback(
    (index: number) => {
      ...
      return question != null && isQuestionAnswered(answers, question.id);
    },
    [answers, questions],
  );
  ...
  function handleSelectAnswer(answerId: number) {
    ...
    setAnswers((prev) => {
      ...
      return {
        ...prev,
        [currentQuestion.id]: toggleExamAnswerSelection(
          currentSelection,
          answerId,
