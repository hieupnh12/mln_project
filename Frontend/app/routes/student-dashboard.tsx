...
const bottomNavItems = [
  { label: "Home", icon: "home", active: true, href: "/student/dashboard" },
  { label: "Library", icon: "menu_book", href: "/student/dashboard#curriculum" },
  { label: "Progress", icon: "query_stats", href: "/student/dashboard#analytics" },
  { label: "Profile", icon: "person", href: "/student/dashboard#dashboard" },
];
        ...
        >
          <div className="min-w-0 space-y-md lg:col-span-7">
            <div className="min-w-0 space-y-xs">
              ...
              <h1 className="max-w-[12ch] break-words text-[32px] font-bold leading-[1.12] text-primary sm:max-w-none sm:text-[42px] lg:text-display-lg">
