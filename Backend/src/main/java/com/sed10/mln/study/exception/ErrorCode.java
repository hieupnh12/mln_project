...
public enum ErrorCode {
    ...
    DATA_TOO_LONG(3017, "Dữ liệu quá dài so với giới hạn cột trong hệ thống (ví dụ: đáp án, tiêu đề, thẻ).", HttpStatus.BAD_REQUEST),
    DATA_DUPLICATE(3018, "Dữ liệu bị trùng khóa duy nhất (ví dụ: thẻ đã tồn tại).", HttpStatus.CONFLICT),
    DATA_REFERENCED(3019, "Không thể thực hiện vì dữ liệu này đang được liên kết ở nơi khác (ví dụ: đang có khóa học, bài giảng...).", HttpStatus.BAD_REQUEST),
    ...
    SUBJECT_DOCUMENT_NOT_FOUND(1003, "Không tìm thấy tài liệu môn học", HttpStatus.NOT_FOUND),
    ...
    UNSUPPORTED_FILE_TYPE(1007, "Unsupported file type. Use PNG, JPG, WEBP, PDF, PPTX, DOC, DOCX, XLS, XLSX, TXT or ZIP", HttpStatus.BAD_REQUEST),
